...
echo '<div class="favoris"><h2>Vos Favoris</h2>';
...
echo '<div class="commandes"><h2>Vos Commandes</h2>';
if ($commandes!=array()){
    foreach ($commandes as $idc => $prods){
        echo '<div class="commande"><p>Commande '.$idc.'</p><br>';
        foreach ($prods as $idp => $qte){
            echo '<p>'.ModelProduits::getProduitById($idp)->getNomProd().' '.$qte.'</p><br>';
        }
        echo '</div>';
    }
}
